...
<script>
	...
	function loadPrice(packageName) {
		...
		ob.open("GET", "loadpprice.jsp?packageName=" + packageName, true);
		ob.send();
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 d-flex justify-content-center">
					<div class="title">
						<h2>
							Book Your <strong class="white">Appointment for Packages</strong>
						</h2>
					</div>
				</div>
			</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
					<form action="packageAppointData.jsp" method="get" id="frmregi">
						<div class="row">
							<%
							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<select class="form-control" style="height: 50px" name="txtpack"
									onchange="loadPrice(this.value)"
									onblur="validateEmpty(this, document.getElementById('errpack'), 'Select Package')">
									...
									ps.close();
									%>
								</select> <span class="text-danger wid" id="errpack"></span>
							</div>
