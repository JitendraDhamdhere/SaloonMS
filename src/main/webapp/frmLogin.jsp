		...
		<div class="container">
			<div class="row">
				<div class=" col-md-12">
					<div class="title">
						<h2>
							Login<strong class="white"> Here And Book</strong> Your
							Appointment
						</h2>
					</div>
				</div>
						...
						<div class="row">
							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<input class="form-control" placeholder="User Name" type="text"
									name="txtuname"> <span class="text-danger wid"
									id=erruName></span>
							</div>
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<input class="form-control" placeholder="Password"
									type="password" name="txtpass"> <span
									class="text-danger wid" id=emailPass></span>
							</div>
							<br>
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<button type="submit" class="send"
									style="background-color: gray; margin-left: 180px">Login</button>
							</div>
						</div>
					</form>
					<div class="row my-4">
						<div class=" col-md-12 d-flex justify-content-center">
							<div class="title">
								<h2>
									<a href="frmRegister.jsp" style="font-size: 20px; color: white">
										Register On </a>
								</h2>
							</div>
						</div>
